...
export default function SettingsScreen() {
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: isDarkMode ? '#1a1a1a' : '#f5f5f5' }}>
      <YStack padding="$4" gap="$6">
        ...
        <Section gap="$4">
          ...
          >
            ...
            <Switch checked={isDarkMode} onCheckedChange={() => toggleTheme()} size="$4">
          ...
          >
            {Object.entries(features).map(([key, enabled]) => (
              <XStack key={key} justifyContent="space-between" alignItems="center">
                ...
                <BodyText color={enabled ? '$green10' : '$gray10'} fontWeight="500">
        ...
        {isAuthenticated && user && (
          <>
            <Section gap="$4">
              ...
              <Button variant="outline" onPress={handleLogout} color="$red10">
                Sign Out
              </Button>
            </Section>
            <Separator />
